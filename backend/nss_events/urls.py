...
from .views import EventAPIView, AttendanceAPIView, EventsAttendedAPIView, CollegeVolunteersAPIView, EventAttendedVolunteersAPIView
...
urlpatterns = [
    ...
    path('college-volunteers/', CollegeVolunteersAPIView.as_view()),
